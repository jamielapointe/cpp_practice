...
// For the record, here is a table summarizing the possible values for
// cpp_practice_COMP_MSVC_LANG: MSVC option Standard MSVC_LANG /std:c++14
...
#  define cpp_practice_COMP_IBM __xlC__
#else
...
#  define cpp_practice_COMP_CLANGFCC \
    (__FCC_major__ * 100 + __FCC_minor__ * 10 + __FCC_patchlevel__)
#else
...
/// without SVE-support
#if defined(_CRAYC) && defined(__clang__)
#  define cpp_practice_COMP_CLANGCPE \
    (_RELEASE_MAJOR * 100 + _RELEASE_MINOR * 10 + _RELEASE_PATCHLEVEL)
#else
...
/// really GCC and not a compatible compiler (e.g., ICC, clang, mingw, etc.)
    ...
    !(cpp_practice_COMP_CLANG || cpp_practice_COMP_ICC ||      \
      ...
      cpp_practice_COMP_ARM || cpp_practice_COMP_EMSCRIPTEN || \
      cpp_practice_COMP_FCC || cpp_practice_COMP_CLANGFCC ||   \
      cpp_practice_COMP_CPE || cpp_practice_COMP_CLANGCPE ||   \
      cpp_practice_COMP_LCC)
#  define cpp_practice_COMP_GNUC_STRICT 1
#else
...
#      define cpp_practice_HAS_ARM64_FP16 1
#    else
#      define cpp_practice_HAS_ARM64_FP16 0
#    endif
#  endif
#endif
...
/// PowerPC
    ...
    defined(__POWERPC__)
#  define cpp_practice_ARCH_PPC 1
#else
#  define cpp_practice_ARCH_PPC 0
#endif
